  ...
  return (
    <div className="relative z-[70] overflow-visible">
      ...
      {open ? (
        <div
          ref={panelRef}
          className="absolute right-0 top-[calc(100%+0.5rem)] z-[90] w-[min(25rem,calc(100vw-2rem))] max-h-[calc(100vh-120px)] overflow-y-auto rounded-[1.35rem] border border-stroke bg-white p-3.5 shadow-[0_22px_60px_rgba(15,23,42,0.18)]"
        >
          ...
          <div className="relative flex items-start justify-between gap-3">
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-slate-500">Settings</p>
              <h3 className="mt-0.5 text-lg font-semibold text-slate-900">Map context</h3>
            </div>
            <button
              type="button"
          ...
          <p className="mt-2 text-xs leading-5 text-slate-500">Location and weekly delivery.</p>
          ...
          <div className="mt-3 border-t border-stroke/80 pt-3">
            <Link
              ...
              className="inline-flex rounded-full border border-stroke bg-canvas px-3 py-1.5 text-sm font-medium text-slate-700 transition hover:bg-white"
            >
              Recommendation ops
            </Link>
          </div>
