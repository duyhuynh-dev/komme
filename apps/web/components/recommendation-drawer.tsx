...
export function RecommendationDrawer({
  ...
  return (
    <aside className="rounded-[2rem] border border-stroke/80 bg-card/80 p-4 shadow-float backdrop-blur">
      <div className="px-2 pb-3">
        <p className="text-xs font-semibold uppercase tracking-[0.22em] text-slate-500">Venue Drawer</p>
        <h2 className="mt-1 text-2xl font-semibold">Top spots this week</h2>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="mt-4 flex flex-wrap items-center gap-3 text-sm text-slate-600">
                ...
                <span>{new Date(card.startsAt).toLocaleString()}</span>
              </div>
              ...
              <div className="mt-4 flex gap-2">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center rounded-full border border-stroke bg-white px-4 py-2 text-sm font-medium text-slate-700"
                >
              ...
              {card.secondaryEvents.length ? (
                <div className="mt-4 rounded-2xl border border-stroke/80 bg-white/70 p-3 text-sm text-slate-600">
                  <p className="font-semibold text-slate-800">Also upcoming here</p>
