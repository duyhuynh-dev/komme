    ...
    for index, selection in enumerate(selections):
        ...
        stops.append(
            TonightPlannerStop(
                ...
                eventUrl=selection.candidate.card.eventUrl,
                sourceConfidence=round(selection.candidate.source_confidence, 2),
    ...
    for candidate, score in ranked_options:
        ...
        results.append(
            TonightPlannerFallbackOption(
                ...
                eventUrl=candidate.card.eventUrl,
                sourceConfidence=round(candidate.source_confidence, 2),
...
def _reroute_from_stop(
    ...
    *,
    ...
    return TonightPlannerRerouteOption(
        ...
        eventUrl=stop.eventUrl,
        sourceConfidence=stop.sourceConfidence,
