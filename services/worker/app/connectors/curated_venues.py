...
HOUSE_OF_YES = CuratedVenueSource(
    key="house-of-yes",
    listing_url="https://www.houseofyes.org/calendar",
    venue=VenueMetadata(
...
KNOCKDOWN_CENTER = CuratedVenueSource(
    key="knockdown-center",
    listing_url="https://knockdown.center/events/",
    venue=VenueMetadata(
...
NUBLU = CuratedVenueSource(
    key="nublu",
    listing_url="https://www.nublu.net/events",
    venue=VenueMetadata(
        venue_name="Nublu",
        neighborhood="East Village",
        address="151 Ave C, New York, NY",
        city="New York City",
        state="NY",
        postal_code="10009",
        latitude=40.7259,
